...
from .agent_interface import AgentInterface  # expose
from .package import check_package, TRAINING_ENV_PATH, ROLLOUT_ENV_PATH
from .side_channels import EnvConfigurationChannel
...
def make(**env_config):
    ...
    print(env_config["env_path"])
    print("Testing")
    print(Path(env_config["env_path"]).is_file())
