...
def collect_episodes(
    ...
    for i in range(n_episodes):
        ...
        if i % 2 == 0:
            ...
            team_agent_2 = "purple_team"
        else:
            team_order = [agent2, agent1]
            team_agent_1 = "purple_team"
            team_agent_2 = "blue_team"

        steps = 0
        episode_done = False
        blue_team_reward = 0
        purple_team_reward = 0

        while not episode_done:
            blue_team_actions = team_order[0].act({0: obs[0], 1: obs[1], 2: obs[2], 3: obs[3]})
            purple_team_actions = team_order[1].act({0: obs[4], 1: obs[5], 2: obs[6], 3: obs[7]})
            actions = {
                0: blue_team_actions[0],
                1: blue_team_actions[1],
                2: blue_team_actions[2],
                3: blue_team_actions[3],
                4: purple_team_actions[0],
                5: purple_team_actions[1],
                6: purple_team_actions[2],
                7: purple_team_actions[3],
            }
            ...
            # logging
            blue_team_reward = reward[0] + reward[1] + reward[2] + reward[3]
            purple_team_reward = reward[4] + reward[5] + reward[6] + reward[7]
...
def summarize_episodes(
    ...
    hist_stats = {
        agent_name: {
            ...
            "purple_team": collections.defaultdict(list),
        }
    ...
    for agent_name in (agent_1_name, agent_2_name):
        ...
        for team in ("blue_team", "purple_team"):
