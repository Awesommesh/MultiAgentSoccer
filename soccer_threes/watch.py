...
if __name__ == "__main__":
    ...
    while True:
        ...
        agent1_actions = agent1.act({0: obs[0], 1: obs[1], 2: obs[2]})
        agent2_actions = agent2.act({0: obs[3], 1: obs[4], 2: obs[5]})
        actions = {
            0: agent1_actions[0],
            1: agent1_actions[1],
            2: agent1_actions[2],
        ...
        # logging
        team0_reward += reward[0] + reward[1] + reward[2]
        team1_reward += reward[3] + reward[4] + reward[5]
