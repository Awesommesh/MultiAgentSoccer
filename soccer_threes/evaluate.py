...
def collect_episodes(
    ...
    for i in range(n_episodes):
        ...
        while not episode_done:
            blue_team_actions = team_order[0].act({0: obs[0], 1: obs[1], 2: obs[2]})
            purple_team_actions = team_order[1].act({0: obs[3], 1: obs[4], 2: obs[5]})
            actions = {
                0: blue_team_actions[0],
                1: blue_team_actions[1],
                2: blue_team_actions[2],
                3: purple_team_actions[0],
                4: purple_team_actions[1],
                5: purple_team_actions[2],
            }
            ...
            # logging
            blue_team_reward = reward[0] + reward[1] + reward[2]
            purple_team_reward = reward[3] + reward[4] + reward[5]
